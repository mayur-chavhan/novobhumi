...
const ComingSoon = () => {
  ...
  const instagramLink = socialLinks.find(l => l.platform === 'instagram')?.url || 'https://www.instagram.com/novobhumi';
  const facebookLink = socialLinks.find(l => l.platform === 'facebook')?.url || 'https://www.facebook.com/novobhumi';
